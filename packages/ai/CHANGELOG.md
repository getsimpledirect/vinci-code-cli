...
- Fixed event streams to reject when a producer closes before emitting a final result, preventing silent hangs and false-success exits after truncated provider responses.
