...
1. **Redaction is applied at display and egress, not at rest.** Session transcripts in
   `~/.pi/agent/sessions/` may contain an unmasked credential you typed or a file you
   read. Treat that directory as sensitive; delete old sessions you do not need.
