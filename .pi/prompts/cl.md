...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/getsimpledirect/vinci-code-cli/issues/123))`
- External: `Added bar ([#456](https://github.com/getsimpledirect/vinci-code-cli/pull/456) by [@user](https://github.com/user))`
